...
namespace ShootCommon.AssetReferences
{
    public class AssetReferenceStorage : IAssetReferenceStorage
    {
        ...
        private static AssetReferenceStorage _instance;

        public bool AllUploded => _workers.Count == 0;
        public int WorkersCount => _workers.Count;
        
        public static AssetReferenceStorage Instance => _instance ??= new AssetReferenceStorage();
        ...
        private void TryUpload()
        {
            ...
            if (_inUploading == 0 && _workers.Count == 0)
            {
                SignalService.Instance.Send(new AllResourcesLoadedSignal());
            }
        }
